...
int high_ascii_to_low_ascii ( unsigned char *p )
{
		/* Convert ASCII 160-255 to closest matching, ASCII within 32-126 */
		if (*p == 160) {		*p = ' ';	return 0;		}
		if (*p == 161) {		*p = 'i';	return 0;		}
		if (*p == 162) {		*p = 'c';	return 0;		}
		if (*p == 163) {		*p = 'E';	return 0;		}
		if (*p == 164) {		*p = 'o';	return 0;		}
		if (*p == 165) {		*p = 'Y';	return 0;		}
		if (*p == 166) {		*p = 'I';	return 0;		}
		if (*p == 167) {	 	*p = 'S';	return 0;		}
		if (*p == 168) {		*p = '-';	return 0;		}
		if (*p == 169) {		*p = 'c';	return 0;		}
		if (*p == 170) {		*p = 'a';	return 0;		}
		if (*p == 171) {		*p = '<';	return 0;		}
		if (*p == 172 || *p == 173) {	*p = '-';	return 0;		}
		if (*p == 174) {		*p = 'r';	return 0;		}
		if (*p == 175) {		*p = '-';	return 0;		}
		if (*p == 176) {		*p = 'o';	return 0;		}
		if (*p == 177) {		*p = '+';	return 0;		}
		if (*p == 178) {		*p = '2';	return 0;		}
		if (*p == 179) {		*p = '3';	return 0;		}
		if (*p == 180) {		*p = '.';	return 0;		}
		if (*p == 181) {		*p = 'u';	return 0;		}
		if (*p == 182) {		*p = 'P';	return 0;		}
		if (*p == 183 || *p == 184) {	*p = '.';	return 0;		}
		if (*p == 185) {		*p = '7';	return 0;		}
		if (*p == 186) {		*p = 'o';	return 0;		}
		if (*p == 187) {		*p = '>';	return 0;		}
		if (*p >= 188 && *p <= 190) {	*p = '4';	return 0;		}
		if (*p == 191) {		*p = '?';	return 0;		}
		if (*p >= 192 && *p <= 198) {	*p = 'A';	return 0;		}
		if (*p == 199) {		*p = 'C';	return 0;		}
		if (*p >= 200 && *p <= 203) {	*p = 'E';	return 0;		}
		if (*p >= 204 && *p <= 207) {	*p = 'I';	return 0;		}
		if (*p == 208) {		*p = 'D';	return 0;		}
		if (*p == 209) {		*p = 'N';	return 0;		}
		if (*p >= 210 && *p <= 214) {	*p = 'O';	return 0;		}
		if (*p == 215) {		*p = 'x';	return 0;		}
		if (*p == 216) {		*p = 'O';	return 0;		}
		if (*p >= 217 && *p <= 220) {	*p = 'U';	return 0;		}
		if (*p == 221) {		*p = 'Y';	return 0;		}
		if (*p == 222) {		*p = 'b';	return 0;		}
		if (*p == 223) {		*p = 'B';	return 0;		}
		if (*p >= 224 && *p <= 230) {	*p = 'a';	return 0;		}
		if (*p == 231) {		*p = 'c';	return 0;		}
		if (*p >= 232 && *p <= 235) {	*p = 'e';	return 0;		}
		if (*p >= 236 && *p <= 239) {	*p = 'i';	return 0;		}
		if (*p == 240) {		*p = 'o';	return 0;		}
		if (*p == 241) {		*p = 'n';	return 0;		}
		if (*p >= 242 && *p <= 246) {	*p = 'o';	return 0;		}
		if (*p == 247) {		*p = '-';	return 0;		}
		if (*p == 248) {		*p = 'o';	return 0;		}
		if (*p >= 249 && *p <= 252) {	*p = 'u';	return 0;		}
		if (*p == 253) {		*p = 'y';	return 0;		}
		if (*p == 254) {		*p = 'b';	return 0;		}
		if (*p == 255) {		*p = 'y';	return 0;		}
